...
ggsave("graphpdf/final_PCA_beforeNormalization.pdf", plot = pca_plot, width = 8, height = 8, dpi = 300, device = "pdf")
...
pca_plot <- autoplot(prcomp(pca_data, scale. = TRUE),
  ...
  theme_minimal() +
  ggtitle("PCA Plot: Samples by Phenotype")
ggsave("graphpdf/final_PCA_beforeBatchCorrectionWithlogNormalized.pdf", plot = pca_plot, width = 8, height = 8, dpi = 300, device = "pdf")
...
pca_plot <- autoplot(prcomp(pca_data, scale. = TRUE),
  ...
  theme_minimal() +
  ggtitle("PCA Plot: Samples by Phenotype")
ggsave("graphpdf/final_PCA_afterBatchCorrection.pdf", plot = pca_plot, width = 8, height = 8, dpi = 300, device = "pdf")
...
pdf("graphpdf/final_volcano_plot.pdf", width = 13.33, height = 13.33)
...
library(pheatmap)
# Save to PNG
pdf("graphpdf/final_Heatmap_top_50_DEGs.pdf", width = 13.33, height = 13.33)
...
pdf("graphpdf/Up_barchart.pdf", width = 13.33, height = 13.33)
...
pdf("graphpdf/Down_barchart.pdf", width = 13.33, height = 13.33)
ggplot(barchart,aes(Count, reorder(Term,Count), fill = Category)) +
  geom_bar(stat = "identity") +
  theme_minimal() +
  facet_wrap( ~Category, nrow = 2, scales = "free") +
...
# Save to PNG
pdf("graphpdf/Annotated_correlation_heatmap.pdf", width = 13.33, height = 13.33)
...
pdf("graphpdf/final_PCA_Variable_Contributions_with_direction.pdf", width = 13.33, height = 13.33)
...
pdf("graphpdf/final_PCA_Centrality_Contributions_to_PC1_barchart.pdf", width = 13.33, height = 13.33)
...
pdf("graphpdf/final_LASSO_CV_plot.pdf", width = 13.33, height = 13.33)
plot(cv_lasso)
...
pdf("graphpdf/final_LASSO_Coefficient_Profiles.pdf", width = 13.33, height = 13.33)
...
pdf("graphpdf/final_error_rate_vs_genes1.pdf", width = 4.00, height = 4.00)
...
pdf("graphpdf/final_RF_Variable_Importance_forBest9Genes.pdf", width = 4.00, height = 4.00)
...
# # Plot variable importance
# pdf("graphpdf/final_RF_Variable_Importance_forSelected13Genes.pdf", width = 4.00, height = 4.00)
# varImpPlot(final_rf, type = 1, main = "Top Gene Importance (MeanDecreaseAccuracy)")
# dev.off()
...
# Plot ROC curve
pdf("graphpdf/final_AUROC_RF1.pdf", width = 4.00, height = 4.00)
...
# Plot ROC curve
pdf("graphpdf/final_AUROC_SVM1.pdf", width = 4.00, height = 4.00)
...
# Plot
pdf("graphpdf/final_AUROC_GLM1.pdf", width = 4.00, height = 4.00)
...
# Save ROC Plot
pdf("graphpdf/final_AUROC_XGB1.pdf", width = 4.00, height = 4.00)
...
ggsave("graphpdf/final_integrated_model_comparison_with_train_and_test.pdf", plot = p_combined, width = 12, height = 12, dpi = 300, device = "pdf")
################################################### performancs evaluation on only training data
...
# Plot
pdf("graphpdf/temp_AUROC_RF_Train_Test.pdf", width = 4.00, height = 4.00)
...
# Plot
pdf("graphpdf/temp_AUROC_SVM_Train_Test.pdf", width = 4.00, height = 4.00)
...
# Plot
pdf("graphpdf/temp_AUROC_GLM_Train_Test.pdf", width = 4.00, height = 4.00)
...
# Plot
pdf("graphpdf/temp_AUROC_XGB_Train_Test.pdf", width = 4.00, height = 4.00)
...
pdf("graphpdf/temp_Combined_Test_AUROC_AllModels.pdf", width = 4.00, height = 4.00)
...
pdf("graphpdf/temp_Combined_Train_AUROC_AllModels.pdf", width = 4.00, height = 4.00)
...
ggsave("graphpdf/final_Model_Performance_Metrics_Comparison_for_all_metrics.pdf", width = 8, height = 8, dpi = 300, device = "pdf")
...
ggplot(perf_df, aes(x = Model, y = Accuracy, fill = Set)) +
  ...
  theme_minimal(base_size = 14) +
  theme(legend.position = "top")
ggsave("graphpdf/final_Model_Performance_Comparison_on_accuarcy.pdf", width = 8, height = 8, dpi = 300, device = "pdf")
